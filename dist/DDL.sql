...
-- Inclui colunas para cadastro de empresa (cnpj, email, senha, etc.)
-- Estabelecimentos inseridos manualmente têm essas colunas como NULL.
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `drop`.`estabelecimentos` (
  `id`              INT           NOT NULL AUTO_INCREMENT,
  `nome`            VARCHAR(150)  NOT NULL,

  -- Acesso da empresa (NULL para estabelecimentos inseridos manualmente)
