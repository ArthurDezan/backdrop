...
-- Nota: cnpj, email, senha, numero_endereco, bairro, cidade NÃO entram no
-- ON DUPLICATE KEY UPDATE para não sobrescrever dados de empresas já cadastradas.


-- -----------------------------------------------------
-- Inserir Produtos (mantido exatamente como o original)
-- -----------------------------------------------------
